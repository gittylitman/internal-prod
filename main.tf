...
resource "azurerm_private_endpoint" "peext" {
  ...
  location            = var.resource_group_location
  resource_group_name = var.resource_group_int_name
  ...
  private_service_connection {
    ...
    private_connection_resource_id = "/subscriptions/a273b4fb-6a3d-4804-a047-5d293da8811d/resourcegroups/rg-ext/providers/Microsoft.Web/sites/wa-try-vnet"
